...

{
        ...
        { {0, 87, 1, 38, 64, 1, 1}, //voices for song2     song 2 is the one that we write to when we're sequencing. It's initially set up to play the reference notes for each voice when we start the device in Program Mode.
          {4, 63, 1, 22, 64, 1, 26},
          {1, 63, 1, 60, 64, 10, 0},
          {2, 75, 2, 80, 64, 10, 0}
        },
